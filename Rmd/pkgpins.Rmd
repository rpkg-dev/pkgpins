...
-   Disadvantages:
    ...
    -   We'd lose the possibility of easily expanding the current functionality (local boards) to remote caching.
    -   pins are some kind of standard we'd lose.
...
-   We don't rely on `pins::pin_write()` because it
    ...
    2.  doesn't allow to alter the defaults of `qs::qsave()`, and
